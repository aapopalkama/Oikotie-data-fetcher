...
def fetch_oikotie(fetch_what):
    ...
    page = "https://asunnot.oikotie.fi/vuokra-asunnot?pagination=1&locations=%5B%5B64,6,%22Helsinki%22%5D%5D&cardType=101"
    driver.get(page)
    ...
    for i in range(1,result):
        url_1="https://asunnot.oikotie.fi/vuokra-asunnot?pagination="
        url_2=str(i)
        url_3="&locations=%5B%5B64,6,%22Helsinki%22%5D%5D&cardType=101"
